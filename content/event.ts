...
/**
 * Canal do evento no Instagram, entregue após preencher a lista de avisos
 * (<WaitlistModal>). O formulário captura o lead; este link confirma o
 * acompanhamento no canal, onde os anúncios saem primeiro.
 */
